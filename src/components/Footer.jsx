                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li className="flex items-start space-x-2">
                                ...
                                <div className="leading-relaxed">
                                    <a href="tel:+94777182110" className="hover:text-gold transition-colors block">
                                        +94 777 182 110
                                    </a>
                                    <a href="tel:+94777667576" className="hover:text-gold transition-colors block">
                                        +94 777 667 576
                                    </a>
                                </div>
                            </li>
                            ...
                            <li className="flex items-start space-x-2">
                                ...
                                <div className="leading-relaxed">
                                    <a href="mailto:info@beeslineexport.com" className="hover:text-gold transition-colors block">
                                        info@beeslineexport.com
                                    </a>
                                    <a href="mailto:beeslineexport@gmail.com" className="hover:text-gold transition-colors block">
